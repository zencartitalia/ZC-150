...
?>
          ...
          <tr>
            ...
            <td class="main" align="left">Ordine #<?php echo $customers_orders->fields['orders_id']; ?></td>
            <td class="main" align="left">ID # Buono Sconto <?php echo $customers_orders->fields['coupon_code']; ?></td>
